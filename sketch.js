...
function draw(){
  background(0);
    ...
    if (gameState==="PLAY"){
        ...
        if (marble.isTouching(invistilegrp)){
            score= score+10;
            scoreSound.play();
        ...
        if (score==200){
            treasure= createSprite( 100, displayHeight/2+100, 20,20);
            ...
            fill("white");
            strokeWeight(8);
            text ("Mission Completed! ", displayWidth/2-20, 25);
        ...
        textSize(30);
        strokeWeight(8);
        text ("Mission Failed! ", displayWidth/2-20, 25);
